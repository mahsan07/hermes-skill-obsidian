...
Obsidian is a focused, shareable agent workflow.

## What it does

Read, search, create, and edit notes in an Obsidian vault while preserving links and structure. Use when the user explicitly requests this capability or a closely related task.
